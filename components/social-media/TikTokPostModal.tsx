...
import { X, Send, Hash, Music } from 'lucide-react'
...
export default function TikTokPostModal({ isOpen, onClose, onPostCreated }: TikTokPostModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error creating TikTok post:', err)
    } finally {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="What's your vibe? Share your creative content..."
          ...
          <div>
            ...
            <input
              ...
              placeholder="fyp,viral,trending,creative"
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-gray-200">
            <button
              ...
              onClick={handleClose}
              disabled={isSubmitting}
              className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-black disabled:opacity-50"
            >
              Cancel
            </button>
            <Button
